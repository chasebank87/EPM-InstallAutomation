...
```
  ...
  * -remoteDeployment tells the script that this is a remote server, and only installs __Essbase Server__
  * Changing the -install switches to $false tells the script not to install those products
